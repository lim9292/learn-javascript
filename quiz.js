...
console.log("A1: " + add(5, 3)); // 예상 결과: 8
...
console.log("A2: " + minus(60, 20)); // 예상 결과: 40
...
console.log("A3: " + introduce("김철수", 25)); // 예시 결과: "안녕하세요, 김철수님. 당신의 나이는 25세입니다."
...
console.log("A4-1. 기본 샌드위치 주문: " + orderSandwich());
console.log("A4-2. 기본 샌드위치 주문: " + orderSandwich("basic"));
console.log("A4-3. 비건 샌드위치 주문: " + orderSandwich("vegan"));
...
console.log("A8-1: 전공이 Physics인 학생:", physicsStudent); // 예상 결과: { name: "Charlie", age: 23, major: "Physics" },

// 2. 이름이 "David"인 학생을 찾으세요.
const davidStudent = students.find((student) => student.name === "David"); // 여기에 코드를 작성하세요.
console.log("A8-2: 이름이 David인 학생:", davidStudent); // 예상 결과:{ name: "David", age: 20, major: "Chemistry" },
